...
const Player = () => {
      const { seekBar, seekBg, seekSong, play, pause, playStatus, track, time, previous, next } = useContext(PlayerContext)
      return (
            <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
                  ...
                  <div className="flex flex-col items-center gap-1 m-auto">
                        ...
                        <div className="flex items-center gap-5">
                              ...
                              <p>
                              {isNaN(time.totalTime.minute) ? '00' : String(time.totalTime.minute).padStart(2, '0')}:
                              {isNaN(time.totalTime.second) ? '00' : String(time.totalTime.second).padStart(2, '0')}
                              </p>
                        </div>
